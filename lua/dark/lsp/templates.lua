...
local dark_lsp_utils = require "dark.lsp.utils"

local ftplugin_dir = dark.lsp.templates_dir
...
local ensure_installed_servers = dark.lsp.installer.setup.ensure_installed
...
function M.generate_ftplugin(server_name, dir)
  ...
  end, dark_lsp_utils.get_supported_filetypes(server_name) or {})
...
---The files are generated to a runtimepath: "$DARKVIM_RUNTIME_DIR/site/after/ftplugin/template.lua"
