...
local lsp_utils = require "dark.lsp.utils"
...
local function make_formatters_info(ft)
  local null_formatters = require "dark.lsp.null-ls.formatters"
...
local function make_code_actions_info(ft)
  local null_actions = require "dark.lsp.null-ls.code_actions"
...
local function make_linters_info(ft)
  local null_linters = require "dark.lsp.null-ls.linters"
...
local function make_auto_lsp_info(ft)
  local skipped_filetypes = dark.lsp.automatic_configuration.skipped_filetypes
  local skipped_servers = dark.lsp.automatic_configuration.skipped_servers
...
function M.toggle_popup(ft)
  ...
  local function set_syntax_hl()
    vim.cmd [[highlight DarkInfoIdentifier gui=bold]]
    vim.cmd [[highlight link DarkInfoHeader Type]]
    vim.fn.matchadd("DarkInfoHeader", "Buffer info")
    vim.fn.matchadd("DarkInfoHeader", "Active client(s)")
    vim.fn.matchadd("DarkInfoHeader", fmt("Overridden %s server(s)", ft))
    vim.fn.matchadd("DarkInfoHeader", "Formatters info")
    vim.fn.matchadd("DarkInfoHeader", "Linters info")
    vim.fn.matchadd("DarkInfoHeader", "Code actions info")
    vim.fn.matchadd("DarkInfoHeader", "Automatic LSP info")
    vim.fn.matchadd("DarkInfoIdentifier", " " .. ft .. "$")
    ...
    tbl_set_highlight(require("dark.lsp.null-ls.formatters").list_registered(ft), "DarkInfoIdentifier")
    tbl_set_highlight(require("dark.lsp.null-ls.linters").list_registered(ft), "DarkInfoIdentifier")
    tbl_set_highlight(require("dark.lsp.null-ls.code_actions").list_registered(ft), "DarkInfoIdentifier")
  end

  local Popup = require("dark.interface.popup"):new {
