...
function M.config()
  ...
  dark.builtin.telescope = vim.tbl_extend("force", dark.builtin.telescope, {
    defaults = {
      prompt_prefix = " ",
      selection_caret = " ",
      entry_prefix = "  ",
...
function M.setup()
  ...
  telescope.setup(dark.builtin.telescope)
  ...
  if dark.builtin.notify.active then
    pcall(function()
      require("telescope").load_extension "notify"
    end)
  end

  if dark.builtin.telescope.on_config_done then
    dark.builtin.telescope.on_config_done(telescope)
  end
